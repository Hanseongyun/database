...
SELECT observe_date, speed_80m FROM jeju2 GROUP BY observe_date;	#실행x
...
-- 주의! WHERE절과 사용방법이 같지만 WHERE절은 SELECT 이전에 실행되고 HAVING절은 SELECT 이후에 실행됨
