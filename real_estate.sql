-- Active: 1706776141213@@127.0.0.1@3306@real_estate
...
-- 10. 특정 게시물 보기
SELECT title, writer_id, wirte_datetime, view_count, contents, reply
FROM qna
WHERE reception_number = 1;

-- 11. 관리자로 답변 작성
UPDATE qna SET reply = '2023년 데이터입니다.' , replyer_id = 'userID' , reply_status = 1   # userID가 관리자아이디라고 가정
WHERE reception_number = 1;
